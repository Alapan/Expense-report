    ...
    <div className="xl:hidden">
      ...
      <div className="m-10">
        <form action={handleCreate} ref={ref}>
          ...
          <button
            type="submit"
            className="inline-block w-1/2 my-4 h-10 text-center text-white bg-lime-700 hover:bg-lime-800 rounded-lg"
          >
            {'Add Expense'}
          </button>
          <div className="my-6">
            <Link href="/tracker" className="underline text-blue-600">
